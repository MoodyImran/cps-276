...
class DatabaseConn {	
  ...
  public function dbOpen(){
    ...
    try {
      ...
      $dbHost = 'localhost';
      $dbName = 'mimran1';//this will be your WCC username
      $dbUsr = 'mimran1';//this will be your WCC username
      $dbPass = 'qUZg4gD36ASH';//this will be the password found in the video.
